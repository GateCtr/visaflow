app.factory('accentRemoveService', [ function() {
    ...
    return {
        removeAccent: function (input) {
            ...
            for (var i = 0; i < diacriticsMap.length; i++) {
                modifiedInput = input.replace(diacriticsMap[i].letters, diacriticsMap[i].base);
                if (input != modifiedInput) return modifiedInput;
            }
