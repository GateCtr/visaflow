export const VISA_PRICING = {
  ...
  spain: {
    ...
    portalUrl: "https://www.citaconsular.es/",
    portalName: "Cita Consular (citaconsular.es) — Ambassade Espagne Kinshasa",
    portalDashboardUrl: "https://www.citaconsular.es/",
    portalAppointmentUrl: "https://www.citaconsular.es/",
    portalScheduleUrl: "https://www.citaconsular.es/",
    processingType: "appointment",
    successCopy: {
      triggerLabel: "Créneau capturé",
    ...
    notes: "Visa Schengen délivré par l'ambassade d'Espagne à Kinshasa via le portail citaconsular.es (Bookitit). Frais consulaires espagnols (90 € adulte) payés séparément par le client directement à l'ambassade.",
  },
  schengen: {
