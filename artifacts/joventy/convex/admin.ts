...
// ─── Rejeter la preuve de paiement d'engagement ───────────────────────────────
// Efface paymentProofUrl → le client doit soumettre un nouveau justificatif.
// Le statut du dossier reste inchangé (toujours awaiting_engagement_payment).
