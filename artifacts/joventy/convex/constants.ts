export const VISA_PRICING = {
  ...
  brazil: {
    ...
    notes: "Le visa Brésil (tourisme VITUR, affaires VITEM II ou études VITEM IV) se dépose sur rendez-vous à l'Ambassade du Brésil à Kinshasa. Joventy prépare votre dossier complet et organise votre rendez-vous consulaire.",
  },
  albania: {
    label: "Albanie",
    flag: "🇦🇱",
...
export const SERVICE_PACKAGES = {
  full_service: {
    ...
    tagline: "Recommandé",
    description: "Joventy gère votre visa de A à Z : dossier complet, formulaires officiels, profil consulaire et obtention du visa ou e-visa. Paiement uniquement à l'obtention — vous ne payez que si vous obtenez votre visa.",
    hasSuccessFee: true,
