...
const guides: Guide[] = [
  ...
  {
    slug: "visa-angleterre-kinshasa-rdv-2026",
    title: "Visa Angleterre depuis Kinshasa RDC 2026 — Procédure UKVI, Biométrie BLS & Délais",
    metaTitle: "Visa Angleterre depuis Kinshasa 2026 — Procédure UKVI & Biométrie BLS | Joventy",
    metaDescription: "Demander un visa Angleterre depuis Kinshasa en 2026 : portail UKVI, biométrie au centre BLS International, documents requis et délais réels. Guide complet pour Congolais.",
    ...
    coverEmoji: "🇬🇧",
    intro:
      "Depuis le Brexit (1er janvier 2021), le Royaume-Uni a son propre système de visa totalement indépendant du Schengen. Pour les Congolais de Kinshasa, la demande se fait en ligne via le portail UKVI (gov.uk), avec une étape biométrie obligatoire dans un centre BLS International agréé. Ce guide vous explique la procédure complète, les documents à préparer, les délais réels en 2026, et comment éviter les refus les plus courants.",
    sections: [
      {
        heading: "Le visa UK n'est pas un visa Schengen — une distinction capitale",
        body:
          "Beaucoup de demandeurs confondent le visa Schengen et le visa britannique. Ce sont deux systèmes totalement distincts depuis le Brexit :",
        list: [
          "Un visa Schengen (France, Belgique, Espagne…) ne donne PAS accès au Royaume-Uni",
          "Un visa Standard Visitor UK ne donne PAS accès à l'espace Schengen",
          "Si vous souhaitez visiter Londres ET Paris, vous avez besoin de deux visas séparés",
          "Le UK a son propre portail de demande : gov.uk/apply-uk-visa",
          "La biométrie UK se fait dans un centre BLS International (pas au CEV, pas à l'ambassade)",
        ],
      },
      {
        heading: "Types de visa UK disponibles depuis Kinshasa en 2026",
        body:
          "Le Royaume-Uni propose plusieurs catégories de visa selon le motif du séjour. Les plus demandés depuis Kinshasa :",
        list: [
          "Standard Visitor Visa (tourisme, visite familiale, affaires) — le plus courant, valable 6 mois, parfois 2 ou 5 ans",
          "Student Visa (Tier 4) — pour étudier dans une université ou école britannique accréditée",
          "Skilled Worker Visa — pour travailler pour un employeur britannique agréé (nécessite un Certificate of Sponsorship)",
          "Family Visa — pour rejoindre un conjoint ou parent résidant légalement au Royaume-Uni",
          "Transit Visa — pour une escale à Londres sans entrer sur le territoire britannique",
        ],
      },
      {
        heading: "Les documents requis pour le Standard Visitor Visa depuis Kinshasa",
        body:
          "Pour le visa touriste/visite (Standard Visitor), voici la liste complète des documents à préparer avant de soumettre votre demande en ligne :",
        list: [
          "Passeport valide avec au moins 6 mois de validité restante et 2 pages vierges",
          "Formulaire de demande en ligne complété sur gov.uk (paiement £115 obligatoire à la soumission)",
          "Relevés bancaires des 3 à 6 derniers mois (solde moyen visible — le UK est très attentif aux finances)",
          "Attestation d'emploi récente ou RCCM pour les indépendants",
          "Lettre d'invitation ou réservation d'hôtel confirmée au Royaume-Uni",
          "Billet d'avion aller-retour (ou réservation confirmée)",
          "Preuve de logement en RDC (titre de propriété, contrat de bail)",
          "Photos biométriques aux normes UK (35×45 mm, fond blanc)",
        ],
      },
      {
        heading: "La procédure étape par étape",
        body: "Voici les 4 étapes pour obtenir votre visa Standard Visitor UK depuis Kinshasa :",
        list: [
          "1 — Remplir et soumettre le formulaire en ligne sur gov.uk/apply-uk-visa. Payer les frais UKVI (£115 pour le Standard Visitor) directement sur le portail par carte bancaire internationale.",
          "2 — Prendre rendez-vous biométrie dans un centre BLS International de Kinshasa (empreintes digitales + photo). Ce rendez-vous est souvent disponible sous 1 à 2 semaines.",
          "3 — Déposer les documents papier au centre BLS (passeport original + pièces justificatives). BLS transmet le dossier au bureau UKVI.",
          "4 — Attendre la décision UKVI : 3 à 6 semaines en moyenne pour un Standard Visitor. Un service Priority (résultat en 5 jours ouvrables) est disponible moyennant un supplément.",
        ],
      },
      {
        heading: "Délais et coûts réels en 2026",
        body:
          "Voici les délais et coûts à anticiper pour un visa UK Standard Visitor depuis Kinshasa en 2026 :",
        list: [
          "Délai standard : 3 à 6 semaines après biométrie — prévoir de la marge avant votre voyage",
          "Service Priority (résultat en 5 jours ouvrables) : £500 supplémentaires",
          "Frais UKVI Standard Visitor : £115 (non remboursables en cas de refus)",
          "Frais BLS International (service + collecte biométrie) : environ £55-80",
          "Total estimé sans le service Priority : environ £170-195 en frais gouvernementaux",
          "Frais Joventy : 200 USD d'engagement + 600 USD de prime de succès (payée uniquement à la confirmation du dossier soumis avec biométrie)",
        ],
      },
      {
        heading: "Les erreurs qui entraînent un refus",
        body:
          "Le visa UK a un taux de refus non négligeable pour les ressortissants congolais. Les motifs les plus fréquents :",
        list: [
          "Relevés bancaires insuffisants ou irréguliers — le UK veut voir un solde stable sur plusieurs mois, pas un dépôt de dernière minute",
          "Absence de liens solides avec la RDC (pas d'emploi stable, pas de propriété, pas de famille à charge)",
          "Formulaire rempli avec des incohérences ou des informations vagues",
          "Photos non conformes aux normes UK (taille, fond, qualité)",
          "Voyage sans itinéraire crédible — la lettre d'invitation ou la réservation d'hôtel doit être cohérente avec votre profil",
          "Voyageurs sans visa UK ni Schengen préalable — le premier visa est toujours le plus difficile à obtenir",
        ],
      },
      {
        heading: "Comment Joventy gère votre dossier UK",
        body:
          "Joventy prend en charge l'intégralité du processus pour maximiser vos chances d'obtenir le visa et vous éviter les erreurs les plus courantes :",
        list: [
          "Préparation et vérification complète de votre dossier (formulaire UKVI, lettres, justificatifs)",
          "Prise de rendez-vous biométrie au centre BLS International de Kinshasa",
          "Suivi de votre dossier à chaque étape et notification WhatsApp",
          "Prime de succès de 600 USD payée uniquement quand le dossier est soumis et biométrie confirmée",
          "Si le dossier n'est pas soumis : aucun solde à payer",
        ],
      },
    ],
    faq: [
      {
        q: "Faut-il un visa pour aller en Angleterre depuis la RDC ?",
        a: "Oui. Les ressortissants congolais (RDC) doivent obtenir un visa pour entrer au Royaume-Uni, quelle que soit la durée du séjour. La demande se fait en ligne sur gov.uk avant le voyage.",
      },
      {
        q: "Le visa Schengen permet-il d'entrer en Angleterre ?",
        a: "Non. Depuis le Brexit (janvier 2021), le Royaume-Uni est sorti de l'espace Schengen. Un visa Schengen ne donne pas accès au Royaume-Uni. Vous avez besoin d'un visa UK séparé.",
      },
      {
        q: "Combien coûte le visa Angleterre depuis Kinshasa avec Joventy ?",
        a: "Frais Joventy : 200 USD d'engagement + 600 USD de prime de succès (payés uniquement quand le dossier est soumis avec biométrie confirmée). Frais UKVI : £115 pour le Standard Visitor, plus les frais BLS (~£55-80). Ces frais gouvernementaux sont payés directement.",
      },
      {
        q: "Quel est le délai pour obtenir un visa UK depuis Kinshasa ?",
        a: "En standard : 3 à 6 semaines après la biométrie. UKVI propose un service Priority (résultat en 5 jours ouvrables) pour £500 supplémentaires. Joventy vous conseille de déposer au moins 6 semaines avant votre voyage.",
      },
      {
        q: "Peut-on faire un visa UK sans avoir de visa Schengen au préalable ?",
        a: "Oui, le visa UK est totalement indépendant du Schengen. Vous pouvez demander un Standard Visitor UK sans avoir voyagé en Europe auparavant. Cela dit, avoir des voyages antérieurs dans votre passeport renforce votre dossier.",
      },
      {
        q: "Où se fait la biométrie pour le visa Angleterre à Kinshasa ?",
        a: "La biométrie (empreintes digitales + photo) pour le visa UK se fait dans un centre BLS International agréé à Kinshasa. Ce n'est pas l'ambassade britannique ni le CEV. Joventy organise ce rendez-vous pour vous.",
      },
    ],
    relatedSlugs: [
      "visa-espagne-kinshasa-rendez-vous-ambassade-2026",
