...
const guides: Guide[] = [
...

  {
    ...
    faq: [
      ...
      { q: "Comment obtenir un visa USA si l'ambassade de Kinshasa est suspendue ?", a: "Si vous êtes hors de la RDC depuis 21+ jours, vous pouvez demander un visa USA dans un pays tiers (Third Country National). Ambassades possibles : Casablanca, Le Caire, Paris, Nairobi. Joventy vous accompagne : WhatsApp +243840808122." },
    ],
...

  {
    ...
    faq: [
      { q: "Puis-je purger mes 21 jours au Congo-Brazzaville ou en Angola ?", a: "Techniquement oui (le CDC ne les interdit pas actuellement), MAIS l'Africa CDC les classe « à haut risque » et ils pourraient être ajoutés à la liste du jour au lendemain. Joventy recommande fortement un pays hors Afrique centrale (Dubaï, Turquie, Europe, Maurice) pour zéro risque. Contactez-nous : +243840808122." },
      { q: "Mon visa Schengen est expiré mais mon visa USA multi-entrées est valide. Que faire ?", a: "Avec un visa USA valide, vous pouvez obtenir : un e-Visa Maroc en 24-72h (77-110 USD), un e-Visa Turquie en 24h, ou un e-Visa Dubaï en 48h. L'île Maurice ne nécessite aucun visa. Joventy gère tout : WhatsApp +243840808122." },
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "📱 Contactez notre équipe sur WhatsApp : +243840808122",
        ],
      },
    ],
    faq: [
