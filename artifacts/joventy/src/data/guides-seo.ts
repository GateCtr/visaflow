...
const guides: Guide[] = [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "⚠️ Pour le visa Schengen de court séjour, les demandes France suivent le circuit CEV lorsqu'il représente la France. Cela ne concerne pas les visas France de long séjour : études longues, famille et travail de plus de 90 jours relèvent de l'Ambassade de France à Kinshasa après le parcours France-Visas. Le formulaire officiel du court séjour reste celui indiqué par France-Visas.",
        list: [
...

  {
    ...
    coverEmoji: "🇪🇸",
    intro:
      "À Kinshasa, le délai entre la réservation d’un rendez-vous visa Espagne et la date du rendez-vous est souvent la principale difficulté. Les observations disponibles indiquent une moyenne d’environ 36 jours, soit près de cinq semaines, mais ce chiffre n’est ni un délai garanti ni une promesse de disponibilité. Ce guide explique comment planifier votre demande et rechercher correctement un créneau sur le parcours Espagne — inscription personnelle auprès de l’ambassade, puis accès au portail officiel citaconsular.es. Joventy peut vous accompagner dans la préparation de votre email et surveiller les créneaux après réception de vos identifiants, sans remplacer l’ambassade ni garantir une date.",
    sections: [
      {
      ...
      {
        heading: "Comment rechercher correctement un rendez-vous sur citaconsular.es",
        body:
          "Une fois vos accès reçus, ouvrez le portail officiel communiqué par l’ambassade : citaconsular.es. Il n’y a pas de liste de catégories à sélectionner dans cette étape : vous consultez directement les disponibilités de l’agenda.",
        list: [
          "1. Ouvrez le portail officiel de réservation citaconsular.es",
        ...
        imageAlt: "Exemple d’un créneau disponible dans l’agenda de l’Ambassade d’Espagne à Kinshasa",
    ...
    faq: [
      ...
      {
        q: "Comment fonctionne la réservation sur citaconsular.es ?",
        a: "Pour l’Espagne à Kinshasa, suivez le lien officiel communiqué par l’ambassade et utilisez votre numéro de passeport ainsi que votre mot de passe.",
      },
      {
...

  {
    ...
    category: "Visa Schengen",
    coverEmoji: "🇪🇸",
      intro: "Pour réserver un rendez-vous visa Espagne depuis Kinshasa, chaque demandeur envoie d’abord personnellement son email à l’Ambassade d’Espagne, puis utilise les accès reçus sur citaconsular.es. Ce guide explique les étapes de réservation. Après réception de vos identifiants, Joventy peut surveiller les créneaux et vous aider à réserver. Ce service porte sur le rendez-vous : il ne comprend pas la préparation complète du dossier visa et ne garantit ni date précise ni délivrance du visa.",
    sections: [
      {
        heading: "Étape 1 — Inscription par email à l'Ambassade d'Espagne",
        body: "La première étape est obligatoire avant toute prise de rendez-vous. Chaque demandeur doit personnellement envoyer un email d'inscription à l'adresse officielle de l'ambassade :",
        list: [
      ...
      },
      {
        ...
        list: [
          ...
          "Le créneau réservé est valable pour vous seul — ne le partagez pas",
           "Joventy peut surveiller les créneaux et vous aider à réserver après réception de vos identifiants",
        ],
      },
      {
      ...
      {
        heading: "Ce qu’il faut avoir avant de chercher un créneau",
        body: "La réservation ne commence qu’après l’inscription auprès de l’ambassade et la réception des identifiants. Pour la demande de créneau, vérifiez que :",
        list: [
          "L’email d’inscription a été envoyé personnellement à l’ambassade.",
          "Les identifiants pour citaconsular.es ont été reçus et fonctionnent.",
          "Le numéro de passeport utilisé correspond au demandeur du rendez-vous.",
          "La période de voyage souhaitée est réaliste et laisse du temps pour l’attente du créneau et l’instruction du visa.",
        ],
        contextualLink: {
          href: "/guides/documents-visa-schengen-kinshasa",
          label: "Consulter la liste des documents à préparer pour le dépôt du visa",
        },
      },
      {
      ...
      {
        heading: "Combien de temps prévoir avant le voyage ?",
        body: "Le délai total varie : il comprend la réponse de l’ambassade à l’inscription, l’attente d’un créneau, la date du rendez-vous, puis l’instruction du visa.",
        list: [
          "La réponse à l’email d’inscription est souvent observée sous 1 à 14 jours, mais peut varier.",
          "La disponibilité d’un créneau sur citaconsular.es n’est pas fixe et aucune date ne peut être promise.",
          "Une moyenne observée d’environ 36 jours entre la réservation et la date du rendez-vous est indicative, pas garantie.",
          "Après le rendez-vous, le délai d’instruction annoncé est de 15 jours, avec des prolongations possibles si des pièces complémentaires sont demandées.",
          "Commencez la démarche suffisamment tôt et évitez d’acheter des billets non modifiables avant d’avoir un calendrier confirmé.",
        ],
      },
      {
        heading: "Ce que Joventy peut faire pour la réservation",
        body: "Après réception de vos identifiants, vous pouvez demander à Joventy un service consacré à la recherche du créneau :",
        list: [
          "Vérification des informations nécessaires à la recherche du créneau.",
          "Surveillance des disponibilités sur citaconsular.es après réception de vos accès.",
          "Aide à la réservation et confirmation des informations du rendez-vous.",
          "Vous envoyez vous-même l’email d’inscription à l’ambassade ; Joventy peut vous aider à le préparer.",
          "Le service concerne le rendez-vous uniquement, pas la préparation complète du dossier visa ni la décision de l’ambassade.",
        ],
      },
    ],
    faq: [
      ...
      {
        q: "Comment prendre rendez-vous pour un visa Espagne à Kinshasa ?",
        a: "Envoyez personnellement l’email d’inscription à emb.kinshasa.citasvis@maec.es avec l’objet demandé. Après réception des identifiants, connectez-vous à citaconsular.es pour rechercher et confirmer un créneau. Joventy peut surveiller les disponibilités et vous aider à réserver après réception de vos accès.",
      },
      {
        q: "Combien de temps faut-il pour avoir un rendez-vous visa Espagne à Kinshasa ?",
        a: "La réponse à l’email est souvent observée sous 1 à 14 jours. Une moyenne d’environ 36 jours entre la réservation et le rendez-vous a été observée, mais les délais varient selon la période et ne sont pas garantis.",
      },
      {
        q: "Joventy peut-il envoyer l'email d'inscription à ma place ?",
        a: "Non : chaque demandeur doit personnellement envoyer son email à emb.kinshasa.citasvis@maec.es. Joventy peut vous aider à le préparer et à vérifier les pièces jointes, puis surveiller les créneaux sur citaconsular.es après réception de vos identifiants.",
      },
      {
      ...
      },
      {
        ...
        a: "N'envoyez pas de deuxième email avant 14 jours — l'ambassade indique qu'un renvoi anticipé peut entraîner un délai supplémentaire de 2 mois. Si après 14 jours vous n'avez pas de réponse, vous pouvez renvoyer votre email. Joventy peut vous aider à vérifier la démarche et surveiller les délais.",
      },
      {
        q: "La réservation d’un créneau garantit-elle l’obtention du visa ?",
        a: "Non. Joventy peut aider à rechercher et réserver un rendez-vous, mais seule l’Ambassade d’Espagne décide d’accorder ou de refuser le visa.",
      },
    ],
    relatedSlugs: [
    ...
    internalLinks: [
      {
        href: "/visa-espagne-kinshasa",
        label: "Visa Espagne depuis Kinshasa",
        description: "Voir la page générale sur les types de visa et les démarches depuis Kinshasa.",
      },
      {
        href: "/ambassade-espagne-kinshasa",
        label: "Ambassade d’Espagne à Kinshasa",
      ...
      },
      {
        href: "/guides/documents-visa-schengen-kinshasa",
        label: "Documents visa Schengen",
        description: "Consulter les pièces à préparer pour le dépôt après le rendez-vous.",
      },
      {
        href: "/creneaux-visa-espagne-kinshasa",
        label: "Service créneau visa Espagne",
        description: "Surveillance et aide à la réservation après inscription et réception des accès.",
      },
    ],
    conversion: {
      ...
      whatsappMessage: "Bonjour Joventy, je souhaite réserver un rendez-vous visa Espagne à Kinshasa. Je voudrais connaître les options standard et express ainsi que les modalités selon l’état de mon inscription à l’ambassade.",
    },
  },
    ...
    sections: [
      {
        ...
        list: [
          ...
          "Compétence : visas de court séjour pour les pays représentés, ainsi que longs séjours Belgique et Luxembourg selon les procédures applicables",
        ],
      },
      {
...

  {
    ...
    title: "Visa Chine à Kinshasa : portail officiel et procédure 2026",
    metaTitle: "Visa Chine Kinshasa 2026 — Portail officiel et dépôt | Joventy",
    metaDescription:
      "Visa Chine depuis Kinshasa : portail officiel visaforchina.cn, examen préliminaire, paiement du service et dépôt au centre officiel. Guide Joventy.",
    publishedDate: "2026-07-01",
    updatedDate: "2026-09-26",
    readingTime: 8,
    category: "Visa Chine",
    coverEmoji: "🇨🇳",
    intro:
      "La demande de visa Chine depuis Kinshasa commence sur le portail officiel visaforchina.cn. Choisissez Kinshasa, créez un compte, complétez le formulaire et téléversez le passeport, la photo et les justificatifs propres à votre catégorie. Après examen préliminaire en ligne, imprimez le certificat joint et présentez-vous au China Visa Application Service Center avec le passeport original. Il n’existe pas de parcours e-Visa à publier pour cette demande.",
    sections: [
      {
        heading: "Où faire sa demande de visa Chine à Kinshasa ?",
        body:
          "Le China Visa Application Service Center reçoit les demandeurs après l’examen préliminaire en ligne. L’adresse officielle est : rez-de-chaussée, Luxury Tower, No. 148 Boulevard du 30 Juin, Gombe, Kinshasa.",
        list: [
          "Portail officiel : https://www.visaforchina.cn/FIH4_FR/",
          "Aucun rendez-vous n’est requis selon l’avis officiel STEP 2",
          "Après approbation en ligne, imprimez le certificat joint et apportez-le avec le passeport original",
        ],
      },
      {
        ...
        list: [
          ...
          "Aucun e-Visa Chine ne doit être présenté comme disponible dans ce parcours.",
          "Les demandes Hong Kong et Macao sont hors de ce flux standard ; les passeports diplomatiques ou officiels sont exemptés du service de transfert.",
        ],
      },
      {
        heading: "Documents requis pour un visa Chine (visa L tourisme) depuis Kinshasa",
        body:
          "La liste exacte dépend de la catégorie choisie et doit être vérifiée sur le portail officiel. Ne remplacez pas sa checklist par une liste générique.",
        list: [
          "Passeport, photo et formulaire téléversés sur le portail",
          "Justificatifs propres à la catégorie de visa choisie",
          "Après approbation : certificat de demande imprimé et passeport original",
          "Photo supplémentaire uniquement si le portail indique que la photo téléversée n’est pas conforme",
        ],
      },
      {
        heading: "Procédure étape par étape : visa Chine à Kinshasa",
        body:
          "Voici le parcours publié par le centre, de la demande en ligne au dépôt des originaux :",
        list: [
          "Étape 1 : Choisissez Kinshasa, créez un compte et complétez le formulaire sur visaforchina.cn",
          "Étape 2 : Téléversez le passeport, la photo et les justificatifs propres à la catégorie",
          "Étape 3 : Utilisez le bouton de la page PAYER, sinon le statut reste PENDING ; le paiement en ligne est indisponible. Transférez le service du centre selon l’avis officiel et téléversez le bordereau en identifiant le nom du demandeur et le numéro de passeport",
          "Étape 4 : Attendez l’examen préliminaire ; corrigez et soumettez à nouveau si le centre le demande",
          "Étape 5 : Après approbation, imprimez le certificat joint et présentez-le avec le passeport original au centre. Aucun rendez-vous n’est requis",
          "Étape 6 : Les droits de visa sont payés au comptoir en espèces uniquement",
        ],
      },
      {
        heading: "Frais officiels et frais Joventy",
        body:
          "Les frais doivent être séparés : ne publiez pas de montant de droit de visa non vérifié.",
        list: [
          "Service du centre selon l’avis officiel : USD 110 en traitement normal ou USD 130 en express",
          "Le paiement en ligne est indisponible : transférez le service selon l’avis officiel et téléversez le bordereau avec le nom du demandeur et le numéro de passeport",
          "Les droits de visa sont payés au comptoir en espèces uniquement ; aucun montant officiel non vérifié n’est publié ici",
          "Les frais Joventy sont distincts des frais officiels et sont présentés séparément lors de la demande",
        ],
      },
      {
        heading: "Comment Joventy gère votre visa Chine depuis Kinshasa",
        body:
          "Joventy peut accompagner l’organisation administrative, sans remplacer le portail ni la décision des autorités :",
        list: [
          "Aide à organiser le compte, le formulaire et les téléversements demandés",
          "Vérification du suivi et des éventuelles demandes de correction ou de re-soumission",
          "Rappel des étapes de paiement et du certificat à imprimer après approbation",
          "Les originaux sont présentés par le demandeur au centre officiel",
    ...
    faq: [
      {
        q: "Peut-on obtenir un visa Chine sans se déplacer au centre ?",
        a: "La demande commence en ligne, puis l’approbation impose de présenter le certificat imprimé et le passeport original au China Visa Application Service Center.",
      },
      {
        q: "Quel est le délai de la procédure ?",
        a: "Le portail prévoit un examen préliminaire en ligne, mais aucun délai individuel ne doit être promis. Le centre peut demander des corrections ou une nouvelle soumission.",
      },
      {
        q: "Hong Kong et Macao suivent-ils ce parcours ?",
        a: "Non. Les demandes Hong Kong et Macao sont exclues de ce flux standard. Les passeports diplomatiques ou officiels sont exemptés du service de transfert.",
      },
      {
        q: "Existe-t-il un e-Visa Chine ?",
        a: "Non. Ne présentez pas cette procédure de demande en ligne et de dépôt du certificat comme un e-Visa.",
      },
      {
        q: "Quels justificatifs faut-il fournir ?",
        a: "Les justificatifs dépendent de la catégorie choisie. Consultez la checklist affichée par le portail officiel et téléversez uniquement les documents demandés ; le centre peut demander une correction ou une nouvelle soumission.",
      },
    ],
    relatedSlugs: [
      "visa-espagne-kinshasa-rendez-vous-ambassade-2026",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "🇪🇸 Espagne (citaconsular.es) : 2 à 6 semaines — inscription email obligatoire en amont, envoyée personnellement par chaque demandeur",
  ...
  },
  {
    ...
    metaDescription:
      "Aucun créneau Espagne à Kinshasa ? Comprenez les causes, vérifiez vos accès, adoptez les bons réflexes et découvrez les options fiables sans promesse de délai.",
    publishedDate: "2026-09-03",
    updatedDate: "2026-09-03",
    readingTime: 9,
    category: "Visa Schengen",
    coverEmoji: "🇪🇸",
    title: "Aucun créneau Espagne à Kinshasa : que faire ?",
    intro:
      "Le portail citaconsular.es peut afficher « aucun créneau disponible » lorsque l'agenda est complet au moment de la recherche. Ce guide explique les causes possibles, les vérifications utiles, les actions conformes et les limites à connaître, sans confondre réponse d'inscription, rendez-vous ou décision de visa. Une surveillance ou une alerte ne garantit ni une date ni un délai.",
    sections: [
      {
        heading: "Pourquoi il n'y a « jamais » de rendez-vous visa Espagne à Kinshasa",
        body:
          "Contrairement à la France ou la Belgique, l'Espagne ne passe pas par le CEV : la réservation se fait sur le portail citaconsular.es après une inscription personnelle par email à l'ambassade. Le portail affiche presque toujours « aucun créneau », non pas parce qu'il n'y en a pas, mais parce que la demande dépasse largement l'offre et que les places publiées disparaissent quasi instantanément. Plusieurs facteurs se combinent :",
        list: [
      ...
      },
      {
        ...
        list: [
          ...
          "La seule approche fiable : un accompagnement transparent qui agit sur VOTRE dossier et VOS identifiants officiels, avec paiement au résultat",
           "Joventy ne revend pas de rendez-vous : après réception de vos identifiants, le service suit le portail pour votre profil et vous aide à réserver ; le service créneau est dû seulement lorsqu'un rendez-vous est effectivement obtenu",
        ],
      },
      {
        heading: "Les options d'aide, sans promesse de délai",
        body:
          "Joventy ne « connaît » pas de porte dérobée : une surveillance peut signaler une disponibilité lorsqu'elle apparaît, mais elle ne contrôle ni la publication des créneaux ni le calendrier de l'ambassade. Vous réservez avec vos propres identifiants.",
        list: [
            "Surveillance de citaconsular.es pour votre profil selon l'offre choisie",
            "Signalement d'une disponibilité pour vous permettre de réserver avec vos accès",
           "Aide à la préparation de l'email, que chaque demandeur envoie personnellement, puis suivi des identifiants",
          "Alerte WhatsApp dès qu'une date est sécurisée, avec l'heure et les instructions pour le jour J",
           "Aucun délai de 24 à 72 heures n'est garanti : une alerte concerne seulement une disponibilité éventuelle, pas la réponse d'inscription, la date du rendez-vous ou la délivrance du visa",
        ],
      },
      {
    ...
    faq: [
      ...
      {
         q: "Un rendez-vous Espagne est-il garanti sous 72 heures ?",
           a: "Non. Les 24 à 72 heures ne constituent ni un délai d'inscription, ni une promesse de rendez-vous, ni un délai de visa. Une alerte signale seulement une disponibilité éventuelle ; la date dépend du portail et de l'ambassade.",
      },
      {
        q: "Faut-il faire l'inscription par email avant de pouvoir réserver ?",
          a: "Oui, c'est obligatoire. Chaque demandeur doit personnellement envoyer un email à emb.kinshasa.citasvis@maec.es (objet : RENDEZ-VOUS VISA EST) avec ses données et pièces jointes. L'ambassade renvoie ensuite les identifiants du portail. Joventy peut aider à préparer et vérifier cet email.",
      },
      {
    ...
    internalLinks: [
      ...
      {
        href: "/guides/delai-rendez-vous-espagne-kinshasa-bookitit-2026",
        label: "Comprendre les quatre délais Espagne",
        description: "Distinguer réponse de l'ambassade, recherche, rendez-vous et traitement du visa.",
      },
      {
        href: "/alerte-espagne",
        label: "Alerte WhatsApp autonome à 10 USD",
        description: "Recevoir un signalement et réserver vous-même avec vos accès.",
      },
    ],
    conversion: {
  ...
  {
    slug: "rendez-vous-visa-france-long-sejour-kinshasa",
    title: "Rendez-vous visa France long séjour à Kinshasa : procédure France-Visas 2026",
    metaTitle: "Rendez-vous visa France long séjour Kinshasa 2026 — France-Visas | Joventy",
    metaDescription: "Procédure pour un rendez-vous visa France long séjour à Kinshasa : France-Visas, pièces, dépôt à l'ambassade et erreurs à éviter.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 8, category: "Visa France", coverEmoji: "🇫🇷",
    intro: "Un projet d'études, de travail ou de famille en France de plus de 90 jours relève du visa long séjour. Depuis Kinshasa, ce parcours est différent du visa Schengen court séjour : il se prépare sur France-Visas et est traité par l'Ambassade de France. Ce guide explique la séquence administrative sans promettre de date ni de décision.",
    sections: [
      { heading: "Distinguer le long séjour du court séjour", body: "Le visa Schengen de court séjour concerne en principe les voyages de 90 jours au plus sur 180. Un visa long séjour français est une procédure nationale destinée notamment aux études, au travail, à la famille ou à l'installation. Ne choisissez pas une demande court séjour pour contourner un projet de longue durée : la catégorie doit correspondre au motif réel.", list: ["Court séjour : circuit CEV lorsqu'il représente la France", "Long séjour : France-Visas puis Ambassade de France à Kinshasa", "La durée, le motif et les pièces doivent être cohérents"] },
      { heading: "Préparer France-Visas avant le rendez-vous", body: "Commencez par l'assistant officiel France-Visas afin d'identifier la catégorie et sa liste documentaire. Remplissez les informations avec les données exactes du passeport, conservez le récépissé et vérifiez la validité des documents. Pour certaines études, le parcours Campus France fait partie des prérequis.", list: ["Passeport, photos et récépissé France-Visas", "Admission, contrat ou preuves du lien familial selon le cas", "Ressources, logement, assurance ou documents complémentaires lorsque demandés", "Originaux, copies et traductions suivant la checklist"] },
      { heading: "Rendez-vous, dépôt et suite du dossier", body: "Suivez uniquement le canal de rendez-vous communiqué pour Kinshasa par France-Visas ou l'ambassade. Le jour du dépôt, présentez-vous avec les originaux et les pièces demandées. L'ambassade peut demander un complément ; les délais dépendent de la catégorie, de la saison et de l'instruction. Évitez d'acheter des billets non remboursables avant une décision.", list: ["Vérifier les consignes actualisées juste avant le dépôt", "Conserver les preuves de dépôt et les messages officiels", "Répondre dans le délai indiqué à toute demande complémentaire"] },
    ],
    faq: [
      { q: "Le visa France long séjour se dépose-t-il au CEV ?", a: "Non. Le CEV concerne le court séjour Schengen lorsqu'il est compétent. Le long séjour français suit France-Visas et les instructions de l'Ambassade de France à Kinshasa." },
      { q: "Faut-il un rendez-vous après France-Visas ?", a: "Oui, si le parcours officiel de votre catégorie prévoit un dépôt sur rendez-vous. Vérifiez les indications affichées par France-Visas et l'ambassade, qui peuvent évoluer." },
      { q: "Joventy peut-il garantir le rendez-vous ou le visa ?", a: "Non. Joventy peut fournir une assistance administrative ; les disponibilités et la décision relèvent exclusivement des canaux et autorités officiels." },
    ],
  ...
  },
  {
    ...
    title: "Visa France long séjour : aucun rendez-vous disponible à Kinshasa, que faire ?",
    metaTitle: "Aucun rendez-vous visa France long séjour Kinshasa 2026 | Joventy",
    metaDescription: "Aucun rendez-vous France long séjour à Kinshasa ? Vérifications France-Visas, bonnes pratiques, vigilance contre les fraudes et assistance de suivi.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 7, category: "Visa France", coverEmoji: "📅",
    intro: "Voir « aucun rendez-vous disponible » est frustrant, mais ne change ni la catégorie de visa ni les exigences du dossier. Pour un long séjour France, vérifiez d'abord France-Visas et les consignes de l'Ambassade de France à Kinshasa. Cette page propose une méthode prudente, sans délai garanti ni promesse d'accès prioritaire.",
    sections: [
      { heading: "Vérifier que vous cherchez dans le bon parcours", body: "Un long séjour France n'est pas un créneau Schengen court séjour. Avant de conclure à une absence de place, confirmez votre catégorie, votre récépissé France-Visas et le canal de dépôt applicable à Kinshasa. Les étudiants doivent aussi vérifier si leur démarche Campus France est finalisée.", list: ["Visa national de plus de 90 jours", "Catégorie exacte : études, famille, travail ou visiteur", "Instructions France-Visas et ambassade à jour"] },
      { heading: "Préparer le dossier pendant l'attente", body: "Une disponibilité n'améliore pas un dossier incomplet. Utilisez l'attente pour contrôler les dates, les noms, les documents financiers et les justificatifs spécifiques. Les pièces d'état civil, traductions et documents de l'établissement ou de l'employeur peuvent nécessiter du temps.", list: ["Ne pas inventer ni modifier des justificatifs", "Conserver les originaux et numérisations lisibles", "Ne pas réserver un voyage non remboursable sur la seule hypothèse d'un créneau"] },
      { heading: "Suivre les informations sans prendre de risque", body: "Consultez les canaux officiels aux moments appropriés et conservez les confirmations. Méfiez-vous des personnes qui vendent un accès « interne », une date garantie ou un visa assuré : aucune assistance privée ne contrôle le calendrier ni la décision de l'ambassade. Une assistance peut suivre le parcours officiel, mais ne le remplace pas.", list: ["Ne communiquez pas vos identifiants à des inconnus", "Vérifiez chaque message et lien auprès de la source officielle", "Signalez les demandes de paiement suspectes"] },
    ],
    faq: [{ q: "Peut-on demander un visa Schengen en attendant ?", a: "Pas pour remplacer un projet de long séjour. La demande doit refléter honnêtement la durée et le motif du séjour." }, { q: "Existe-t-il un délai garanti pour un rendez-vous ?", a: "Non. Les disponibilités dépendent des ouvertures officielles et de la catégorie." }, { q: "Le service Joventy donne-t-il un accès privilégié ?", a: "Non. Joventy n'a pas d'accès privilégié ; il peut seulement assister le suivi administratif du canal officiel." }],
  ...
  },
  {
    ...
    title: "Visa étudiant France depuis Kinshasa : Campus France et long séjour 2026",
    metaTitle: "Visa étudiant France Kinshasa 2026 — Campus France & long séjour | Joventy",
    metaDescription: "Étudier en France depuis Kinshasa : admission, Campus France lorsque requis, France-Visas et visa long séjour étudiant. Checklist et rendez-vous.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 9, category: "Visa France", coverEmoji: "🎓",
    intro: "Un cursus en France de plus de 90 jours exige généralement un visa long séjour étudiant, et non un visa Schengen. L'admission dans l'établissement, le parcours Campus France lorsqu'il s'applique, la demande France-Visas et le dépôt sont des étapes distinctes. Les exigences dépendent du programme et de votre situation.",
    sections: [
      { heading: "Admission et projet d'études cohérent", body: "Obtenez une admission ou une préinscription conforme à votre niveau et à votre projet. L'établissement, les dates de formation et le financement doivent être cohérents avec la demande. Une lettre de motivation peut expliquer votre parcours, sans remplacer les preuves demandées.", list: ["Lettre d'admission ou préinscription", "Diplômes, relevés et curriculum vitae selon le dossier", "Projet académique clair et documenté"] },
      { heading: "Campus France puis France-Visas", body: "Selon votre situation et les règles applicables en RDC, Campus France peut être une étape préalable. Consultez ses instructions officielles et ne confondez pas l'évaluation du projet avec la demande de visa. Une fois les prérequis accomplis, France-Visas indique la procédure et les pièces adaptées au visa étudiant.", list: ["Vérifier si Campus France est requis pour votre cursus", "Conserver les attestations et messages de procédure", "Compléter France-Visas avec les informations exactes"] },
      { heading: "Financement et dépôt du visa long séjour", body: "Préparez des preuves de ressources, d'hébergement et de couverture adaptées à la checklist officielle. Le dépôt du long séjour relève de l'Ambassade de France à Kinshasa selon les instructions en vigueur. L'admission n'emporte pas automatiquement la délivrance du visa : l'autorité consulaire évalue le dossier.", list: ["Preuves de ressources ou prise en charge documentée", "Justificatif d'hébergement selon le cas", "Passeport, photos, récépissé France-Visas et originaux"] },
    ],
    faq: [{ q: "Le visa étudiant France est-il Schengen ?", a: "Pour une formation de plus de 90 jours, c'est un visa long séjour national, distinct du Schengen court séjour." }, { q: "Campus France garantit-il le visa ?", a: "Non. Campus France et l'ambassade ont des rôles distincts ; la décision de visa appartient à l'autorité consulaire." }, { q: "Puis-je déposer avant d'avoir l'admission ?", a: "Suivez la checklist de votre parcours officiel : une admission ou préinscription est généralement une pièce essentielle." }],
  ...
  },
  {
    ...
    title: "Visa France regroupement familial ou conjoint depuis Kinshasa 2026",
    metaTitle: "Visa conjoint et regroupement familial France Kinshasa 2026 | Joventy",
    metaDescription: "Visa France famille depuis Kinshasa : conjoint, regroupement familial, France-Visas et dépôt long séjour à l'ambassade. Pièces et rendez-vous.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 8, category: "Visa France", coverEmoji: "👨‍👩‍👧",
    intro: "Rejoindre un conjoint ou sa famille en France peut relever de plusieurs catégories de visa long séjour. La catégorie dépend du lien familial, du statut de la personne en France et de la procédure déjà engagée. Ce guide fournit des repères pratiques ; une situation familiale complexe peut nécessiter l'avis d'un professionnel du droit ou des autorités compétentes.",
    sections: [
      { heading: "Identifier la catégorie familiale adaptée", body: "Les termes « visa conjoint » et « regroupement familial » ne recouvrent pas toujours la même procédure. Vérifiez le statut du proche résidant en France, votre lien et les instructions France-Visas. N'utilisez pas un motif touristique si l'objectif réel est de s'installer.", list: ["Acte de mariage, naissance ou preuve de filiation selon le cas", "Statut et résidence régulière du proche en France", "Catégorie France-Visas correspondant exactement à la situation"] },
      { heading: "Constituer des preuves fiables", body: "Les documents d'état civil doivent être lisibles, cohérents et accompagnés des formalités ou traductions demandées. Ajoutez les justificatifs de vie commune, de logement ou de ressources seulement lorsqu'ils sont prévus par votre checklist. Des documents inexacts ou contradictoires peuvent compromettre le dossier.", list: ["Originaux et copies des actes", "Documents du proche en France demandés par la procédure", "Traductions certifiées et légalisations si requises"] },
      { heading: "France-Visas, rendez-vous et instruction", body: "Une fois la procédure administrative préalable achevée, complétez France-Visas et suivez le canal de rendez-vous de l'Ambassade de France à Kinshasa. Le dépôt d'un long séjour ne passe pas par le CEV. Le délai et l'issue ne peuvent être garantis ; l'ambassade peut solliciter des compléments.", list: ["Récépissé France-Visas", "Rendez-vous dans la catégorie long séjour correcte", "Ne pas engager de dépenses irréversibles avant la décision"] },
    ],
    faq: [{ q: "Le regroupement familial est-il un visa Schengen ?", a: "Non, il relève généralement d'un visa long séjour national. Vérifiez la catégorie exacte sur France-Visas." }, { q: "Puis-je obtenir le visa parce que mon conjoint vit en France ?", a: "Le lien familial est important, mais l'autorité examine l'ensemble des conditions et des pièces applicables ; aucune issue ne peut être promise." }, { q: "Le CEV reçoit-il ce dossier ?", a: "Le CEV concerne le court séjour Schengen lorsqu'il est compétent. Le long séjour familial français relève de l'ambassade selon le parcours France-Visas." }],
  ...
  {
    slug: "visa-belgique-long-sejour-kinshasa-procedure",
    title: "Visa Belgique long séjour type D depuis Kinshasa : procédure 2026",
    metaTitle: "Visa Belgique type D Kinshasa : procédure CEV 2026 | Joventy",
    metaDescription: "Procédure visa Belgique long séjour type D depuis Kinshasa : Visa On Web, CEV, dépôt et vérifications officielles par motif.",
    publishedDate: "2026-09-06",
    updatedDate: "2026-09-06",
    readingTime: 7,
    category: "Visa Belgique long séjour",
    coverEmoji: "🇧🇪",
    intro: "Un visa belge de type D correspond à un séjour de plus de 90 jours. Depuis Kinshasa, le CEV reçoit les demandes de long séjour Belgique et Luxembourg. Ce guide distingue ce parcours national du visa Schengen de court séjour et renvoie aux sources qui font foi.",
    sections: [
      { heading: "Visa D : un séjour national de plus de 90 jours", body: "Le type D ne doit pas être traité comme un visa C de court séjour. Études, travail, regroupement familial, mariage ou cohabitation légale, recherche et autres motifs relèvent chacun d’une catégorie et de conditions propres.", list: ["Identifier le motif réel du séjour", "Ne pas utiliser une catégorie de court séjour", "Vérifier les conditions actualisées avant de constituer le dossier"] },
      { heading: "Commencer par Visa On Web", body: "Créez vous-même le compte Visa On Web avec votre email personnel et choisissez la catégorie exacte. Les informations saisies doivent correspondre aux documents ; conservez l’accès au compte et contrôlez le formulaire avant la suite.", list: ["Email personnel du demandeur", "Données d’identité exactes", "Catégorie de visa D adaptée", "Formulaire et références à conserver"] },
      { heading: "CEV, checklist et dépôt", body: "Le CEV de Kinshasa reçoit les longs séjours Belgique et Luxembourg. Consultez cev-kin.eu et diplomatie.belgium.be pour le rendez-vous et la checklist de votre motif ; le rendez-vous officiel est gratuit.", list: ["Vérifier la checklist officielle du motif", "Préparer originaux, copies, traductions ou légalisations demandées", "Suivre les instructions du CEV pour le dépôt", "Ne pas confondre ce circuit avec France ou Allemagne long séjour"] },
      { heading: "Frais, instruction et décision", body: "Selon la catégorie, une redevance ou contribution, des droits consulaires, un certificat médical, un extrait de casier judiciaire ou une autorisation préalable peuvent être demandés. Les montants et pièces se vérifient au moment de la demande. L’obtention d’un rendez-vous, l’instruction et une décision éventuelle de l’Office des étrangers sont des étapes distinctes.", list: ["Ne pas payer sur la base d’un tarif ancien", "Conserver les preuves demandées", "Ne pas promettre de délai ou de décision", "Suivre uniquement les canaux officiels"] },
    ],
    faq: [
      { q: "Le visa D belge concerne-t-il un séjour de plus de 90 jours ?", a: "Oui. Il s’agit d’un visa national de long séjour, distinct du visa C Schengen de court séjour." },
      { q: "Le CEV reçoit-il un visa D pour la Belgique ?", a: "Oui, le CEV de Kinshasa reçoit les longs séjours Belgique et Luxembourg ; consultez ses consignes actuelles." },
      { q: "Quels sites faut-il vérifier ?", a: "Vérifiez cev-kin.eu, diplomatie.belgium.be et les informations de l’Office des étrangers pour la catégorie concernée." },
      { q: "Le rendez-vous garantit-il le visa ?", a: "Non. Un rendez-vous ne préjuge ni de l’instruction ni de la décision des autorités compétentes." },
    ],
    relatedSlugs: ["visa-etudiant-belgique-kinshasa", "regroupement-familial-belgique-kinshasa", "visa-travail-belgique-permis-unique-kinshasa"],
    relatedDestination: "visa-belgique-long-sejour-kinshasa",
    internalLinks: [
      { href: "/visa-belgique-long-sejour-kinshasa", label: "Hub visa Belgique long séjour", description: "Comparer les motifs et le parcours type D." },
      { href: "/creneaux-visa-belgique-long-sejour-kinshasa", label: "Service créneau Belgique type D", description: "Service privé distinct du rendez-vous CEV gratuit." },
    ],
  },
  {
    slug: "visa-etudiant-belgique-kinshasa",
    title: "Visa étudiant Belgique depuis Kinshasa : parcours long séjour 2026",
    metaTitle: "Visa étudiant Belgique Kinshasa : visa D 2026 | Joventy",
    metaDescription: "Visa étudiant Belgique depuis Kinshasa : admission, financement, équivalence si applicable, Visa On Web, CEV et vérifications officielles.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 7, category: "Visa Belgique long séjour", coverEmoji: "🎓",
    intro: "Pour étudier en Belgique plus de 90 jours, vérifiez le parcours de visa D étudiant correspondant à votre formation. L’admission ne remplace pas les autres exigences : chaque pièce doit être confirmée dans la checklist officielle.",
    sections: [
      { heading: "Admission et projet d’études", body: "Commencez par l’admission ou le document exigé par l’établissement et vérifiez que le projet correspond à la catégorie de séjour. Les autorités examinent le dossier selon les règles applicables.", list: ["Conserver la preuve d’admission", "Vérifier le type et la durée du programme", "Préparer un parcours cohérent"] },
      { heading: "Financement et preuves", body: "Les moyens de subsistance et les preuves acceptées dépendent de la procédure en vigueur. Ne reprenez pas un seuil trouvé sur une ancienne publication : consultez la source officielle pour votre année et votre situation.", list: ["Suivre le format de preuve demandé", "Documenter l’origine des fonds lorsque nécessaire", "Éviter les documents incohérents ou incomplets"] },
      { heading: "Équivalence et documents académiques", body: "Une équivalence peut être pertinente selon le niveau, le cursus ou l’institution ; elle ne s’applique pas automatiquement à tous les dossiers. Vérifiez directement auprès de l’établissement et des autorités compétentes.", list: ["Demander si l’équivalence est applicable", "Prévoir les traductions ou légalisations requises", "Conserver diplômes et relevés originaux"] },
      { heading: "Visa On Web, CEV et après le dépôt", body: "Créez un compte Visa On Web personnel, choisissez le motif étudiant et consultez la checklist CEV. Le rendez-vous officiel est gratuit. Après dépôt, l’instruction et la décision suivent leur propre calendrier, sans garantie de délai.", list: ["Compte email personnel", "Checklist officielle à jour", "Dépôt au CEV selon instructions", "Suivi par les canaux officiels"] },
    ],
    faq: [
      { q: "Une admission suffit-elle pour obtenir le visa étudiant ?", a: "Non. Elle est une pièce importante, mais les autres exigences de la catégorie doivent aussi être satisfaites." },
      { q: "L’équivalence est-elle toujours obligatoire ?", a: "Non. Elle peut être applicable selon le cursus ; vérifiez votre cas auprès des autorités et de l’établissement." },
      { q: "Où déposer un visa D étudiant belge depuis Kinshasa ?", a: "Suivez Visa On Web et les instructions du CEV, compétent pour les longs séjours Belgique." },
      { q: "Joventy garantit-il l’admission ou le visa ?", a: "Non. Joventy peut assister administrativement ; l’admission et la décision de visa relèvent des organismes compétents." },
    ],
    relatedSlugs: ["visa-belgique-long-sejour-kinshasa-procedure", "regroupement-familial-belgique-kinshasa", "visa-travail-belgique-permis-unique-kinshasa"],
    relatedDestination: "visa-belgique-long-sejour-kinshasa",
    internalLinks: [{ href: "/visa-belgique-long-sejour-kinshasa", label: "Visa Belgique type D", description: "Revenir au hub général du long séjour." }, { href: "/creneaux-visa-belgique-long-sejour-kinshasa", label: "Créneau CEV Belgique", description: "Comprendre le service privé de créneau." }],
  },
  {
    slug: "regroupement-familial-belgique-kinshasa",
    title: "Regroupement familial Belgique depuis Kinshasa : visa D 2026",
    metaTitle: "Regroupement familial Belgique Kinshasa : visa D | Joventy",
    metaDescription: "Regroupement familial Belgique depuis Kinshasa : catégories du sponsor, état civil, preuves et procédure Visa On Web/CEV à vérifier.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 8, category: "Visa Belgique long séjour", coverEmoji: "👨‍👩‍👧",
    intro: "Le regroupement familial belge de plus de 90 jours relève du visa D. Les conditions changent selon que le sponsor est belge, citoyen UE ou ressortissant non-UE : utilisez impérativement la checklist officielle adaptée.",
    sections: [
      { heading: "Identifier la catégorie du sponsor", body: "Le statut du membre de famille rejoint est déterminant. Les règles pour un Belge, un citoyen de l’Union européenne et un ressortissant non-UE ne sont pas interchangeables.", list: ["Confirmer nationalité et statut de séjour du sponsor", "Choisir la rubrique officielle correspondante", "Ne pas généraliser les conditions d’une catégorie à une autre"] },
      { heading: "État civil et preuve du lien", body: "Les actes et preuves du lien familial doivent être préparés dans la forme demandée. Les exigences de traduction, légalisation ou vérification se contrôlent dans la checklist officielle.", list: ["Actes d’état civil pertinents", "Documents lisibles et cohérents", "Traductions ou légalisations si exigées"] },
      { heading: "Logement, ressources et assurance selon la catégorie", body: "Selon le statut du sponsor et le lien invoqué, des preuves de logement, de ressources ou d’assurance peuvent être requises. Vérifiez le contenu et la période de validité attendus plutôt que de vous fonder sur des seuils ou listes non officiels.", list: ["Suivre la checklist de la catégorie", "Préparer les preuves au nom approprié", "Éviter les montants officiels non vérifiés"] },
      { heading: "Mariage et cohabitation légale", body: "Un projet de mariage ou de cohabitation légale nécessite la catégorie officielle appropriée ; il ne faut pas le présenter comme un regroupement ordinaire sans vérifier la procédure. Les preuves d’état civil, de relation et tout document complémentaire demandé doivent être examinés au cas par cas.", list: ["Vérifier la procédure exacte avant Visa On Web", "Préparer les preuves demandées sans inventer de critères", "Consulter CEV, diplomatie belge et Office des étrangers"] },
    ],
    faq: [
      { q: "Les règles sont-elles les mêmes pour tous les sponsors ?", a: "Non. Elles dépendent notamment du statut belge, UE ou non-UE du sponsor." },
      { q: "Quels documents de relation faut-il fournir ?", a: "La checklist officielle de votre catégorie indique les actes et preuves attendus, ainsi que les formalités éventuelles." },
      { q: "Le mariage ou la cohabitation légale est-il traité automatiquement comme un regroupement ?", a: "Non. Vérifiez la catégorie et la procédure officielles adaptées à votre projet." },
      { q: "Où trouver la checklist à jour ?", a: "Sur cev-kin.eu, diplomatie.belgium.be et les informations de l’Office des étrangers." },
    ],
    relatedSlugs: ["visa-belgique-long-sejour-kinshasa-procedure", "visa-etudiant-belgique-kinshasa", "visa-travail-belgique-permis-unique-kinshasa"],
    relatedDestination: "visa-belgique-long-sejour-kinshasa",
    internalLinks: [{ href: "/visa-belgique-long-sejour-kinshasa", label: "Hub visa D Belgique", description: "Voir l’ensemble des motifs de long séjour." }, { href: "/creneaux-visa-belgique-long-sejour-kinshasa", label: "Créneau visa D Belgique", description: "Rendez-vous officiel gratuit et service privé distinct." }],
  },
  {
    slug: "visa-travail-belgique-permis-unique-kinshasa",
    title: "Visa travail Belgique et permis unique depuis Kinshasa 2026",
    metaTitle: "Visa travail Belgique permis unique Kinshasa | Joventy",
    metaDescription: "Visa travail Belgique depuis Kinshasa : employeur, région, permis unique selon le cas, Visa On Web et CEV. Sans promesse d’emploi ou de visa.",
    publishedDate: "2026-09-06", updatedDate: "2026-09-06", readingTime: 7, category: "Visa Belgique long séjour", coverEmoji: "💼",
    intro: "Un projet de travail en Belgique peut nécessiter, selon le cas, une démarche menée par l’employeur auprès de la région compétente et un permis unique avant le visa D. Ce guide ne remplace pas les instructions officielles et ne promet ni emploi ni visa.",
    sections: [
      { heading: "Emploi réel et rôle de l’employeur", body: "Le visa ne crée pas une offre de travail. L’employeur et le projet professionnel doivent être réels et suivre les démarches qui leur incombent.", list: ["Ne pas acheter de promesse d’emploi", "Vérifier l’identité et le rôle de l’employeur", "Garder les documents professionnels authentiques"] },
      { heading: "Région compétente et permis unique", body: "Selon la situation, l’employeur introduit une demande liée au travail auprès de la région compétente ; un permis unique ou une autorisation préalable peut intervenir avant la demande de visa. Les cas et conditions doivent être confirmés officiellement.", list: ["Vérifier la région compétente", "Attendre l’autorisation requise lorsqu’elle s’applique", "Ne pas supposer qu’un contrat suffit dans tous les cas"] },
      { heading: "Demande Visa On Web et pièces", body: "Après les étapes préalables applicables, le demandeur crée son compte Visa On Web personnel dans la catégorie correcte. La checklist peut prévoir des pièces d’identité, médicales, judiciaires ou professionnelles selon le cas.", list: ["Compte avec email personnel", "Catégorie visa D travail correcte", "Checklist, traductions et légalisations à jour"] },
      { heading: "CEV, instruction et décision", body: "Le CEV de Kinshasa reçoit les longs séjours Belgique. La prise de rendez-vous officielle est gratuite. La date de dépôt, l’examen du dossier et la décision des autorités sont distincts ; aucun intermédiaire ne peut les garantir.", list: ["Suivre CEV Kinshasa", "Distinguer frais officiels et assistance privée", "Ne pas promettre de calendrier", "Consulter l’Office des étrangers"] },
    ],
    faq: [
      { q: "Le permis unique est-il nécessaire dans tous les cas ?", a: "Il peut être requis selon la situation. L’employeur et les autorités compétentes confirment la procédure applicable." },
      { q: "Joventy peut-il trouver un emploi belge ?", a: "Non. Joventy n’offre ni ne garantit un emploi ; il peut accompagner des démarches administratives." },
      { q: "Puis-je demander le visa avant l’autorisation de travail ?", a: "Suivez l’ordre prévu pour votre cas officiel ; certaines demandes exigent une décision ou autorisation préalable." },
      { q: "Le rendez-vous CEV est-il payant ?", a: "Le rendez-vous officiel est gratuit. Un éventuel service Joventy est privé et distinct." },
    ],
    relatedSlugs: ["visa-belgique-long-sejour-kinshasa-procedure", "visa-etudiant-belgique-kinshasa", "regroupement-familial-belgique-kinshasa"],
    relatedDestination: "visa-belgique-long-sejour-kinshasa",
    internalLinks: [{ href: "/visa-belgique-long-sejour-kinshasa", label: "Visa Belgique long séjour", description: "Revenir au hub type D." }, { href: "/creneaux-visa-belgique-long-sejour-kinshasa", label: "Service créneau visa D", description: "Voir les conditions du service privé Joventy." }],
  },
];
