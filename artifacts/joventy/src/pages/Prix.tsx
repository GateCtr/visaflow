...
const DESTINATIONS = [
  ...
  { code: "cn", name: "Visa Chine", types: "Demande en ligne, examen préliminaire et dépôt au centre officiel", delay: "Variable selon l’examen officiel", href: "/visa-chine-kinshasa", alert: null, note: "ℹ️ Choisissez Kinshasa sur visaforchina.cn. Aucun rendez-vous requis ; frais Joventy distincts des frais officiels." },
